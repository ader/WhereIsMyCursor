...
- 顏色：從綠色 (最近) 到紅色 (最遠)
- 閃爍：遠距離快閃，近距離不閃
- 閃爍方式：非對稱透明度切換 (80% 顯示 100% / 20% 暗淡 30%)

| 級別 | 距離範圍 | 箭頭顏色 | 閃爍間隔 | 線條粗細 |
|------|----------|----------|----------|----------|
| 0 | 0 - 400px | 亮綠色 (#48FF00) | 不閃爍 | 3px |
| 1 | 400 - 800px | 綠色 (#6CFF00) | 1000ms (極慢) | 3px |
| 2 | 800 - 1200px | 淺綠色 (#A0FF00) | 700ms (慢閃) | 3px |
| 3 | 1200 - 1600px | 黃綠色 (#D4F000) | 500ms (慢閃) | 3px |
| 4 | 1600 - 2000px | 黃色 (#FFE100) | 400ms (中閃) | 3px |
| 5 | 2000 - 2400px | 橘黃色 (#FFB400) | 300ms (中閃) | 3px |
| 6 | 2400 - 2800px | 橘色 (#FF8700) | 300ms (快閃) | 3px |
| 7 | 2800 - 3200px | 橘紅色 (#FF5A00) | 200ms (快閃) | 3px |
| 8 | 3200 - 3600px | 紅橘色 (#FF2D00) | 200ms (快閃) | 3px |
| 9 | ≥ 3600px | 紅色 (#FF0000) | 150ms (快閃) | 3px |
